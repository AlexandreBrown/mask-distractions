...
class SAC(object):
    def __init__(
        ...
        self.actor = m.Actor(actor_encoder, action_shape, hidden_dim, actor_log_std_min, actor_log_std_max).cuda()
        ...
        self.critic_optimizer = torch.optim.Adam(
            self.critic.parameters(), lr=critic_lr, betas=(critic_beta, 0.999), weight_decay=critic_weight_decay
        )
